...
public class WorldClocks implements ActionListener {
    ...
    HashMap<String, TimeZone> cityZone = new HashMap<String, TimeZone>();
    ...
    public void loop() {
    	...
    	for (String cityName: cityZone.keySet()) {
    	
        	timeZone = cityZone.get(cityName);
        ...
        allCities = allCities + cityName + "\n" + dateStr + "\n" + timeStr + "\n";
        
        
        }
    
    	textArea.setText(allCities);
        frame.pack();
    }
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        if (arg0.getSource() == addCity) {
        	...
        	String cityName = JOptionPane.showInputDialog("Enter city here (City name, Country)");
        	timeZone = clockUtil.getTimeZoneFromCityName(cityName);
        	
        	cityZone.put(cityName, timeZone);
